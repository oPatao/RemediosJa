      ...
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        <View style={styles.header}>
          <View>
            ...
            <Text style={styles.headerTextLarge}>Esquina do pato, 361 ▼</Text>
          </View>
        ...
        <View style={styles.tabBar}>
            <TouchableOpacity style={styles.tabItem}>
                <AntDesign name="home" size={24} color="#28a745" />
                <Text style={[styles.tabText, {color: '#28a745'}]}>Início</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.tabItem}>
